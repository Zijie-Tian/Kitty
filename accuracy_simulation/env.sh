...
if [[ -f "${_kitty_env_file}" ]]; then
  _kitty_env_preserve_vars=(
    ...
    DATA_ROOT LONGBENCH_DATA_ROOT RULER_DATA_ROOT RULER_SOURCE_ROOT PPL_DATA_PATH
    OUTPUT_DIR LOG_DIR OUT_ROOT
    MAX_SAMPLES MAX_MODEL_LEN MAX_GEN PROMPT_TOKEN_RESERVE PREFILL_TOKENS SCORE_TOKENS TORCH_DTYPE DTYPE
    ...
    KITTY_PYTHON_BIN KITTY_CONDA_ENV KITTY_LLAMA31_8B_PATH KITTY_LLAMA32_1B_PATH KITTY_LLAMA32_3B_PATH KITTY_MINICPM5_1B_PATH KITTY_QWEN3_8B_PATH
    KITTY_WIKITEXT2_TRAIN_PATH KITTY_WIKITEXT2_TEST_PATH KITTY_LLAMA32_1B_QLUTATTN_MASK KITTY_LLAMA32_3B_QLUTATTN_MASK KITTY_MINICPM5_1B_QLUTATTN_MASK
    QLUT_CB_MASK
    ...
    LLAMA32_MODEL_ID LLAMA32_MODEL_PATH LLAMA32_MODEL_SLUG LLAMA32_MAX_GEN RUN_MODE RUN_VARIANT
  )
