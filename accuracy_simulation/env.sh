...
if [[ -f "${_kitty_env_file}" ]]; then
  _kitty_env_preserve_vars=(
    ...
    DATA_ROOT LONGBENCH_DATA_ROOT RULER_DATA_ROOT RULER_SOURCE_ROOT
    OUTPUT_DIR LOG_DIR OUT_ROOT
    MAX_SAMPLES MAX_MODEL_LEN MAX_GEN PROMPT_TOKEN_RESERVE TORCH_DTYPE DTYPE
    ...
    KITTY_PYTHON_BIN KITTY_CONDA_ENV KITTY_LLAMA31_8B_PATH KITTY_LLAMA32_1B_PATH KITTY_MINICPM5_1B_PATH KITTY_QWEN3_8B_PATH
    KITTY_WIKITEXT2_TRAIN_PATH KITTY_LLAMA32_1B_QLUTATTN_MASK KITTY_MINICPM5_1B_QLUTATTN_MASK
    QLUT_CB_MASK
